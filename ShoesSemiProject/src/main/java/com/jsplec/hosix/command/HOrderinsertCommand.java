...
public class HOrderinsertCommand implements HCommand {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
        ...
        int oPrice = Integer.parseInt(request.getParameter("pPrice"))*Integer.parseInt(request.getParameter("cQty"));
